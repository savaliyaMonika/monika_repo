                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('updateUser') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" value="{{ $result->email }}" name="email" value="{{ old('email') }}" required autocomplete="email">
